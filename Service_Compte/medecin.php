...
<div id="deleteModal" class="modal">
    <div class="header">
        ...
        <div class="txtcard">
        <span class="title">Supprimer utilisateur</span>
                <p class="message">Êtes-vous sûr de vouloir supprimer cet utilisateur ? Toutes ses donnees associees seront definitivement supprimees. Cette action est irreversible !</p>
            </div>
            <div class="actions">
...
<div id="AllComp" class="AllComp">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="medecin.php"><i class='bx bx-store-alt'></i>Medecins</a></li>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th> Specialisation <span class="icon-arrow">&UpArrow;</span></th>
                            ...
                            <tbody>
                                <?php
                                include("../assets/php/getMedecin.php");
                                ?>
                                <!-- <tr>
                                    <td> 3</td>
    ...
    <script src="../assets/ajax/delete_User.js"></script>
    <script src="../assets/ajax/disponible.js"></script>
    <script>


        // Loop through each td and add a click event listener
        // Get all the <p> elements with the 'status' class and attach click event listeners
        document.querySelectorAll('.status').forEach(statusP => {
            statusP.addEventListener('click', () => {
                // Toggle classes between 'delivered' and 'cancelled'
                if (statusP.classList.contains('delivered')) {
                    statusP.classList.remove('delivered');
                    statusP.classList.add('cancelled');
                    statusP.innerText = 'Indisponible';  // Change the text to "Indisponible"
                } else if (statusP.classList.contains('cancelled')) {
                    statusP.classList.remove('cancelled');
                    statusP.classList.add('delivered');
                    statusP.innerText = 'En cours';  // Change the text to "En cours"
                }
            });
        });
