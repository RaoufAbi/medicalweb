...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="paramedical.php"><i class='bx bx-analyse'></i>Pramedical</a></li>
                ...
                <main class="table" id="customers_table">
                    ...
                    <section class="table__body">
                        <table>
                            ...
                            <tbody>
                                <?php
                                include("../assets/php/getParamedical.php");
                                ?>
                                <!-- <tr>
                                    <td> 3</td>
    ...
    <script>
        ...
        tdElements.forEach(td => {
            td.addEventListener('click', () => {
                const statusP = td.querySelector('.status'); // Get the <p> inside the <td>
                ...
                if (statusP) {
                    ...
                    if (statusP.classList.contains('delivered')) {
                        ...
                        statusP.innerText = 'indisponible';  // Change the text to "Annule" or something else
                    } else if (statusP.classList.contains('cancelled')) {
                        statusP.classList.remove('cancelled');
                        statusP.classList.add('delivered');
                        statusP.innerText = 'En cours';  // Change the text to "En cours" or something else
                    }
                }
            });
        });
    ...
    <script src="../assets/ajax/delete_User.js">
    </script>
</body>
